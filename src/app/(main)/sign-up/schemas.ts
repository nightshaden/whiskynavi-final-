...
export const signUpSchema = z
  .object({
    ...
    name: nameSchema,
    phone: z.string().min(1, "본인인증 정보가 올바르지 않습니다.").max(20),
    birthDate: z.string().min(1, "본인인증 정보가 올바르지 않습니다."),
    gender: z.enum(["M", "F", "N"], {
      message: "본인인증 정보가 올바르지 않습니다.",
    }),
    niceRequestNo: z.string().min(1, "NICE 본인인증을 완료해주세요."),
    niceWebTransactionId: z.string().min(1, "NICE 본인인증을 완료해주세요."),
