            ...
            <div className="mx-auto max-w-4xl text-center">
              ...
              {currentBanner.link ? (
                <a
                  ...
                  className="inline-block bg-white/90 px-5 py-2 text-sm font-medium text-black transition-all hover:bg-white md:px-8 md:py-3 md:text-base lg:px-10 lg:py-4 lg:text-lg"
                >
                  자세히 보기
                </a>
              ) : (
                <span className="inline-block bg-white/90 px-5 py-2 text-sm font-medium text-black md:px-8 md:py-3 md:text-base lg:px-10 lg:py-4 lg:text-lg">
                  자세히 보기
                </span>
              )}
            </div>
