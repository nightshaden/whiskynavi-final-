  ...
  return (
    <section className="mt-15">
      <div className="flex gap-8 mt-15 justify-center">
        <div className="flex justify-center items-center h-[375px] w-[375px] border-[0.85px] border-white border-opacity-20">
          <Image
            src="/detail-sample.png"
            alt={SAMPLE.name}
            width={263}
            height={350}
          />
        ...
        <div>
          <h2 className="typo-bold-24 text-white">{SAMPLE.name}</h2>
          <ul className="flex flex-col gap-5 mt-6 my-[10px] text-white typo-medium-18">
            <li>sf</li>
            <li>sf</li>
          </ul>
        </div>
